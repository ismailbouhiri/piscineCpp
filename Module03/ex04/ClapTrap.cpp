...
void	ClapTrap::beRepaired(unsigned int amount)
{
	...
	if (this->_HitPoints != this->_MaxHitPoints)
	{
		...
		this->_HitPoints	 =  ( (int)Energy + this->_HitPoints > this->_MaxHitPoints ) ? this->_MaxHitPoints : Energy + this->_HitPoints;
	}
	else
	{
		Energy				 =	( (int)amount >= this->_MaxEnergyPoints ) ? this->_MaxEnergyPoints : amount;
		this->_EnergyPoints	 =  ( (int)Energy + this->_EnergyPoints > this->_MaxEnergyPoints ) ? this->_MaxEnergyPoints : Energy + this->_EnergyPoints;	
	}
